...
void test_read_sequence_from_fasta(){
  ...
  int length_seq;
  FILE* fp1 = fopen("../test/test_seq_dir/one_entry.fasta", "r");
  ...
  FILE* fp2 = fopen("../test/test_seq_dir/three_entries.fasta", "r");
...
void test_read_sequence_from_fastq(){
  ...
  int length_seq;
  FILE* fp1 = fopen("../test/test_seq_dir/one_entry.fastq", "r");
  ...
  FILE* fp2 = fopen("../test/test_seq_dir/three_entries.fastq", "r");

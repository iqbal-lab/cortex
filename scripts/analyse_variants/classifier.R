...
## modify this to hold the output of make_covg_file.pl   ##<<<<<<<<<<<< MODIFY BLAHBLAH.covg_for_classifier to be your file
d<-read.table("BLAHBLAH.covg_for_classifier", as.is=T, head=F);

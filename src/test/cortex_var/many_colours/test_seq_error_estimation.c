...
void test_estimate_seq_error_rate_for_one_colour_from_snp_allele_fasta_test2()
{
  ...
  long double default_err_rate = 0.01;
  estimate_seq_error_rate_from_snps_for_each_colour("../data/test/pop_graph/seq_error_estimation/colour_list_test_sample2", &ginfo, db_graph, -1, 770, default_err_rate);

  printf("ZAMMER got seq err rate %Ld\n", ginfo.seq_err[0]);
  CU_ASSERT_DOUBLE_EQUAL(ginfo.seq_err[0],0.02, 0.01);

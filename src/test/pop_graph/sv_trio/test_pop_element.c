...
void test_get_chromosome_overlap_direction()
{
  ...
  e->chrom_xs[0]=1;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,2)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,3)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,4)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,5)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,6)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,7)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,8)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,9)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,10)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,11)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,12)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,13)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,14)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,15)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,16)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,17)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,18)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,19)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,20)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,21)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,22)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,23)==does_not_overlap     );
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,24)==does_not_overlap     );

  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,1)==overlaps_forwards_only     );
  e->chrom_xs[0]=2;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,1)==overlaps_reverse_only     );
  e->chrom_xs[0]=3;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,1)==overlaps_both_directions     );
  e->chrom_xs[0]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,1)==does_not_overlap     );
  ...
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,2)==overlaps_forwards_only     );
  e->chrom_xs[0]=8;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,2)==overlaps_reverse_only     );
  e->chrom_xs[0]=12;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,2)==overlaps_both_directions     );
  e->chrom_xs[0]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,2)==does_not_overlap     );
  ...
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,3)==overlaps_forwards_only     );
  e->chrom_xs[0]=32;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,3)==overlaps_reverse_only     );
  e->chrom_xs[0]=48;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,3)==overlaps_both_directions     );
  e->chrom_xs[0]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,3)==does_not_overlap     );
  ...
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,4)==overlaps_forwards_only     );
  e->chrom_xs[0]=128;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,4)==overlaps_reverse_only     );
  e->chrom_xs[0]=192;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,4)==overlaps_both_directions     );
  e->chrom_xs[0]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,4)==does_not_overlap     );
  ...
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,5)==overlaps_forwards_only     );
  e->chrom_xs[1]=2;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,5)==overlaps_reverse_only     );
  e->chrom_xs[1]=3;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,5)==overlaps_both_directions     );
  e->chrom_xs[1]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,5)==does_not_overlap     );
  ...
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,6)==overlaps_forwards_only     );
  e->chrom_xs[1]=8;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,6)==overlaps_reverse_only     );
  e->chrom_xs[1]=12;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,6)==overlaps_both_directions     );
  e->chrom_xs[1]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,6)==does_not_overlap     );
  ...
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,7)==overlaps_forwards_only     );
  e->chrom_xs[1]=32;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,7)==overlaps_reverse_only     );
  e->chrom_xs[1]=48;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,7)==overlaps_both_directions     );
  e->chrom_xs[1]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,7)==does_not_overlap     );
  ...
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,8)==overlaps_forwards_only     );
  e->chrom_xs[1]=128;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,8)==overlaps_reverse_only     );
  e->chrom_xs[1]=192;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,8)==overlaps_both_directions     );
  e->chrom_xs[1]=0;
  CU_ASSERT( db_node_get_chromosome_overlap_direction(e,8)==does_not_overlap     );
